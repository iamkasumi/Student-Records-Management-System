<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($rows_count > 0) {
            ...
            echo "<script> window.open('../html/fac-manage-grades-9.php', '_self')</script>";
        }
        
        else {

            $insert = "INSERT INTO `score-g9` (StudentID, Filipino, English, Mathematics, Science, MAPEH, AP, ESP, TLE)
