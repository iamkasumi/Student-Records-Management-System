                        ...
                        <table class="data-table">
                            ...
                            <?php
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    $select_query = "SELECT * FROM `archive-g9` WHERE CONCAT(Name, LRN) LIKE '%$filtervalues%'";
                                } else {
                                    $select_query = "SELECT * FROM `archive-g9`";
                                }
                            ...
                            <tr class="data">
                                ...
                                <form action="../php/restore-g9.php" method="post">
                                    <td>
