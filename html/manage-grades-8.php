                    ...
                    <div class="table-container">
                        ...
                        <div class="search-container">
                            ...
                            <?php
                                if(isset($_GET['search'])) {
                                    ...
                                    $select_query = "SELECT * FROM `grade-8` WHERE CONCAT(Name, LRN) LIKE '%$filtervalues%'";
                                } else {
                                    $select_query = "SELECT * FROM `grade-8`";
                                }
                        ...
                        <table class="data-table">
                            ...
                            <tr class="data">
                                ...
                                <form action="add-grades-8.php" method="post">
                                    <td>
                                ...
                                <form action="view-grades-8.php" method="post">
                                    <td>
                                ...
                                <form action="edit-grades-8.php" method="post">
                                    <td>
