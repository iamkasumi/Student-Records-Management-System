...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/fac-edit-grades.css?v=<?php echo time(); ?>">
                    ...
                    <div class="table-container">
                        ...
                        <?php
                            ...
                            if (isset($_POST['ID'])) {
                                ...
                                $sql = "SELECT * FROM `studentstb` WHERE ID = '$id' ";
                                $result = mysqli_query($conn, $sql);
                                $row = mysqli_fetch_array($result);

                                $sql_grd = "SELECT * FROM `gradestb` WHERE ID = '$id' ";
                        ...
                        <form action="../php/fac-edit-gradesFunc.php" method="post" class="stud-table">
                            ...
                            <div class="new-student">
                                <a href="fac-manage-grades.php"><h6>Back</h6></a>
                            </div>
