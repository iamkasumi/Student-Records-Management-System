            ...
            <div class="main__container">
                ...
                <div class="main__title">
                    ...
                    <div class="main__greeting">
                        ...
                        <p>Records of Grade 8 students.</p>
                    </div>
                ...
                <div class="main__content">
                    ...
                    <div class="table-container">
                        ...
                        <div class="new-student">
                            <a href="add-students-8.php"><h6>Add New Student</h6></a>
                        </div>
                        ...
                        <table class="data-table">
                            ...
                            <tr class="data">
                                ...
                                <form action="view-students-8.php" method="post">
                                    <td>
                                ...
                                <form action="edit-students-8.php" method="post">
                                    <td>
                                ...
                                <form action="../php/delete-g8.php" method="post">
                                    <td>
