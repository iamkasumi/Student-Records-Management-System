...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/fac-add-grades.css?v=<?php echo time(); ?>">
                    ...
                    <div class="table-container">
                        ...
                        <?php
                            if (isset($_POST['ID'])) {
                                ...
                                $sql = "SELECT * FROM `grade-10` WHERE ID = '$id' ";
                        ...
                        <form action="../php/fac-add-gradesFunc-10.php" method="post" class="stud-table">
                            ...
                            <div class="new-student">
                                <a href="fac-manage-grades-10.php"><h6>Back</h6></a>
                            </div>
