<?php
	...
	$id = $_POST['ID'];
	$query = mysqli_query($conn,"SELECT * FROM `grade-7` WHERE ID = '$id'");
            ...
            <div class="main__container">
                ...
                <div class="main__content">
                    ...
                    <div class="table-container">
                        ...
                        <form action="../php/edit-studentsFunc-7.php" method="POST" class="stud-table">
                            ...
                            <div class="new-student">
                                <a href="manage-stud-7.php"><h6>Back</h6></a>
                            </div>
