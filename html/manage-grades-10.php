...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/manage-grades-year.css?v=<?php echo time(); ?>">
            ...
            <div class="main__container">
                ...
                <div class="main__content">
                    ...
                    <div class="table-container">
                        ...
                        <!-- BACK BUTTON -->
                        <div class="back-bttn">
                            <a href="manage-grades.php"><i class="fa-solid fa-arrow-left"></i></a>
                            <p>Grade 10</p>
                        </div>
                        ...
                        <div class="search-container">
                            ...
                            <?php
                                if(isset($_GET['search'])) {
                                    ...
                                    $select_query = "SELECT * FROM `grade-10` where CONCAT(Name, LRN) LIKE '%$filtervalues%'";
                                } else {
                                    $select_query = "SELECT * FROM `grade-10`";
                                }
                        ...
                        <table class="data-table">
                            ...
                            <tr class="data">
                                ...
                                <form action="add-grades-10.php" method="post">
                                    <td>
                                ...
                                <form action="view-grades-10.php" method="post">
                                    <td>
                                ...
                                <form action="edit-grades-10.php" method="post">
                                    <td>
