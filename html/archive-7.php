                        ...
                        <table class="data-table">
                            ...
                            <?php
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    $select_query = "SELECT * FROM `archive-g7` WHERE CONCAT(Name, LRN) LIKE '%$filtervalues%'";
                                } else {
                                    $select_query = "SELECT * FROM `archive-g7`";
                                }
                            ...
                            <tr class="data">
                                ...
                                <form action="../php/restore-g7.php" method="post">
                                    <td>
