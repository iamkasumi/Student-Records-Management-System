            ...
            <div class="main__container">
                ...
                <div class="main__title">
                    ...
                    <div class="main__greeting">
                        ...
                        <p>Records of Grade 7 students.</p>
                    </div>
                ...
                <div class="main__content">
                    ...
                    <div class="table-container">
                        ...
                        <div class="new-student">
                            <a href="add-students-7.php"><h6>Add New Student</h6></a>
                        </div>
                        ...
                        <table class="data-table">
                            ...
                            <tr class="data">
                                ...
                                <form action="view-students-7.php" method="post">
                                    <td>
                                ...
                                <form action="edit-students-7.php" method="post">
                                    <td>
                                ...
                                <form action="../php/delete-g7.php" method="post">
                                    <td>
