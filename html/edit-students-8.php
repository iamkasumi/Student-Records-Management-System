<?php
	...
	$id = $_POST['ID'];
	$query = mysqli_query($conn,"SELECT * FROM `grade-8` WHERE ID = '$id'");
            ...
            <div class="main__container">
                ...
                <div class="main__content">
                    ...
                    <div class="table-container">
                        ...
                        <form action="../php/edit-studentsFunc-8.php" method="POST" class="stud-table">
                            ...
                            <div class="new-student">
                                <a href="manage-stud-8.php"><h6>Back</h6></a>
                            </div>
