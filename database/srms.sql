...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2023 at 12:50 AM
...
--
-- Table structure for table `archive-7`
--

CREATE TABLE `archive-7` (
  `ID` int(11) NOT NULL,
...
--
-- Table structure for table `archive-8`
--

CREATE TABLE `archive-8` (
  `ID` int(11) NOT NULL,
  `Name` varchar(50) NOT NULL,
  `LRN` varchar(12) NOT NULL,
  `Email` varchar(50) NOT NULL,
...
--
-- Table structure for table `archive-9`
--

CREATE TABLE `archive-9` (
  `ID` int(11) NOT NULL,
  `Name` varchar(50) NOT NULL,
  `LRN` varchar(12) NOT NULL,
  `Email` varchar(50) NOT NULL,
...
--
-- Table structure for table `archive-10`
--

CREATE TABLE `archive-10` (
  `ID` int(11) NOT NULL,
  `Name` varchar(50) NOT NULL,
  `LRN` varchar(12) NOT NULL,
  `Email` varchar(50) NOT NULL,
...
--
-- Indexes for table `archive-7`
--
ALTER TABLE `archive-7`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `LRN` (`LRN`,`Email`);

--
-- Indexes for table `archive-8`
--
ALTER TABLE `archive-8`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `LRN` (`LRN`,`Email`);

--
-- Indexes for table `archive-9`
--
ALTER TABLE `archive-9`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `LRN` (`LRN`,`Email`);

--
-- Indexes for table `archive-10`
--
ALTER TABLE `archive-10`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `LRN` (`LRN`,`Email`);
...
--
-- AUTO_INCREMENT for table `archive-7`
--
ALTER TABLE `archive-7`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archive-8`
--
ALTER TABLE `archive-8`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archive-9`
--
ALTER TABLE `archive-9`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archive-10`
--
ALTER TABLE `archive-10`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
